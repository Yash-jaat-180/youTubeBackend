...
import { changeCurrentPassword, clearWatchHistory, getCurrentUser, getUserChannalProfile, getWatchHistory, loginUser, logoutUser, refreshAccessToken, registerUser, updateAccountDetails, updateUserAvatar, updateUserCoverImage } from "../controllers/user.contoller.js"; // I can import like this only if there is not export default
